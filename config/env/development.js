...
module.exports = {
  db: {
<<<<<<< HEAD
    uri: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/meanexpense',
=======
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mean-dev',
>>>>>>> 7eedfcc6cf362af8c7363809d50e64d0aa636464
    options: {
      user: '',
      pass: ''
    },
